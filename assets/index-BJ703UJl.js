 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ll=()=>xl().__FIREBASE_DEFAULTS__,Fl=()=>{if(typeof process>"u"||typeof _o>"u")return;const n=_o.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},Bl=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=n&&Ol(n[1]);return t&&JSON.parse(t)},Ds=()=>{try{return Ll()||Fl()||Bl()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},Ul=n=>{var t,e;return(e=(t=Ds())===null||t===void 0?void 0:t.emulatorHosts)===null||e===void 0?void 0:e[n]},ql=n=>{const t=Ul(n);if(!t)return;const e=t.lastIndexOf(":");if(e<=0||e+1===t.length)throw new Error(`Invalid host ${t} with no separate hostname and port!`);const r=parseInt(t.substring(e+1),10);return t[0]==="["?[t.substring(1,e-1),r]:[t.substring(0,e),r]},ya=()=>{var n;return(n=Ds())===null||n===void 0?void 0:n.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zl(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Gl(){var n;const t=(n=Ds())===null||n===void 0?void 0:n.forceEnvironment;if(t==="node")return!0;if(t==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function Kl(){return!Gl()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function Hl(){try{return typeof indexedDB=="object"}catch{return!1}}function Wl(){return new Promise((n,t)=>{try{let e=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),e||self.indexedDB.deleteDatabase(r),n(!0)},i.onupgradeneeded=()=>{e=!1},i.onerror=()=>{var o;t(((o=i.error)===null||o===void 0?void 0:o.message)||"")}}catch(e){t(e)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ql="FirebaseError";class Me extends Error{constructor(t,e,r){super(e),this.code=t,this.customData=r,this.name=Ql,Object.setPrototypeOf(this,Me.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ea.prototype.create)}}class Ea{constructor(t,e,r){this.service=t,this.serviceName=e,this.errors=r}create(t,...e){const r=e[0]||{},i=`${this.service}/${t}`,o=this.errors[t],a=o?Yl(o,r):"Error",c=`${this.serviceName}: ${a} (${i}).`;return new Me(i,c,r)}}function Yl(n,t){return n.replace(Xl,(e,r)=>{const i=t[r];return i!=null?String(i):`<${r}?>`})}const Xl=/\{\$([^}]+)}/g;function hs(n,t){if(n===t)return!0;const e=Object.keys(n),r=Object.keys(t);for(const i of e){if(!r.includes(i))return!1;const o=n[i],a=t[i];if(yo(o)&&yo(a)){if(!hs(o,a))return!1}else if(o!==a)return!1}for(const i of r)if(!e.includes(i))return!1;return!0}function yo(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jl{constructor(t,e){this.name=t,this.container=e,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const e=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(e)){const r=new jl;if(this.instancesDeferred.set(e,r),this.isInitialized(e)||this.shouldAutoInitialize())try{const i=this.getOrInitializeService({instanceIdentifier:e});i&&r.resolve(i)}catch{}}return this.instancesDeferred.get(e).promise}getImmediate(t){var e;const r=this.normalizeInstanceIdentifier(t==null?void 0:t.identifier),i=(e=t==null?void 0:t.optional)!==null&&e!==void 0?e:!1;if(this.isInitialized(r)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:r})}catch(o){if(i)return null;throw o}else{if(i)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(tc(t))try{this.getOrInitializeService({instanceIdentifier:ae})}catch{}for(const[e,r]of this.instancesDeferred.entries()){const i=this.normalizeInstanceIdentifier(e);try{const o=this.getOrInitializeService({instanceIdentifier:i});r.resolve(o)}catch{}}}}clearInstance(t=ae){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(e=>"INTERNAL"in e).map(e=>e.INTERNAL.delete()),...t.filter(e=>"_delete"in e).map(e=>e._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=ae){return this.instances.has(t)}getOptions(t=ae){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:e={}}=t,r=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(r))throw Error(`${this.name}(${r}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const i=this.getOrInitializeService({instanceIdentifier:r,options:e});for(const[o,a]of this.instancesDeferred.entries()){const c=this.normalizeInstanceIdentifier(o);r===c&&a.resolve(i)}return i}onInit(t,e){var r;const i=this.normalizeInstanceIdentifier(e),o=(r=this.onInitCallbacks.get(i))!==null&&r!==void 0?r:new Set;o.add(t),this.onInitCallbacks.set(i,o);const a=this.instances.get(i);return a&&t(a,i),()=>{o.delete(t)}}invokeOnInitCallbacks(t,e){const r=this.onInitCallbacks.get(e);if(r)for(const i of r)try{i(t,e)}catch{}}getOrInitializeService({instanceIdentifier:t,options:e={}}){let r=this.instances.get(t);if(!r&&this.component&&(r=this.component.instanceFactory(this.container,{instanceIdentifier:Zl(t),options:e}),this.instances.set(t,r),this.instancesOptions.set(t,e),this.invokeOnInitCallbacks(r,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,r)}catch{}return r||null}normalizeInstanceIdentifier(t=ae){return this.component?this.component.multipleInstances?t:ae:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function Zl(n){return n===ae?void 0:n}function tc(n){return n.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var j;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(j||(j={}));const nc={debug:j.DEBUG,verbose:j.VERBOSE,info:j.INFO,warn:j.WARN,error:j.ERROR,silent:j.SILENT},rc=j.INFO,sc={[j.DEBUG]:"log",[j.VERBOSE]:"log",[j.INFO]:"info",[j.WARN]:"warn",[j.ERROR]:"error"},ic=(n,t,...e)=>{if(t<n.logLevel)return;const r=new Date().toISOString(),i=sc[t];if(i)console[i](`[${r}]  ${n.name}:`,...e);else throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class va{constructor(t){this.name=t,this._logLevel=rc,this._logHandler=ic,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(t){if(!(t in j))throw new TypeError(`Invalid value "${t}" assigned to \`logLevel\``);this._logLevel=t}setLogLevel(t){this._logLevel=typeof t=="string"?nc[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if(typeof t!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}debug(...t){this._userLogHandler&&this._userLogHandler(this,j.DEBUG,...t),this._logHandler(this,j.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,j.VERBOSE,...t),this._logHandler(this,j.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,j.INFO,...t),this._logHandler(this,j.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,j.WARN,...t),this._logHandler(this,j.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,j.ERROR,...t),this._logHandler(this,j.ERROR,...t)}}const oc=(n,t)=>t.some(e=>n instanceof e);let Eo,vo;function ac(){return Eo||(Eo=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function uc(){return vo||(vo=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Ta=new WeakMap,ds=new WeakMap,Ia=new WeakMap,rs=new WeakMap,Ns=new WeakMap;function lc(n){const t=new Promise((e,r)=>{const i=()=>{n.removeEventListener("success",o),n.removeEventListener("error",a)},o=()=>{e(Yt(n.result)),i()},a=()=>{r(n.error),i()};n.addEventListener("success",o),n.addEventListener("error",a)});return t.then(e=>{e instanceof IDBCursor&&Ta.set(e,n)}).catch(()=>{}),Ns.set(t,n),t}function cc(n){if(ds.has(n))return;const t=new Promise((e,r)=>{const i=()=>{n.removeEventListener("complete",o),n.removeEventListener("error",a),n.removeEventListener("abort",a)},o=()=>{e(),i()},a=()=>{r(n.error||new DOMException("AbortError","AbortError")),i()};n.addEventListener("complete",o),n.addEventListener("error",a),n.addEventListener("abort",a)});ds.set(n,t)}let fs={get(n,t,e){if(n instanceof IDBTransaction){if(t==="done")return ds.get(n);if(t==="objectStoreNames")return n.objectStoreNames||Ia.get(n);if(t==="store")return e.objectStoreNames[1]?void 0:e.objectStore(e.objectStoreNames[0])}return Yt(n[t])},set(n,t,e){return n[t]=e,!0},has(n,t){return n instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in n}};function hc(n){fs=n(fs)}function dc(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(t,...e){const r=n.call(ss(this),t,...e);return Ia.set(r,t.sort?t.sort():[t]),Yt(r)}:uc().includes(n)?function(...t){return n.apply(ss(this),t),Yt(Ta.get(this))}:function(...t){return Yt(n.apply(ss(this),t))}}function fc(n){return typeof n=="function"?dc(n):(n instanceof IDBTransaction&&cc(n),oc(n,ac())?new Proxy(n,fs):n)}function Yt(n){if(n instanceof IDBRequest)return lc(n);if(rs.has(n))return rs.get(n);const t=fc(n);return t!==n&&(rs.set(n,t),Ns.set(t,n)),t}const ss=n=>Ns.get(n);function mc(n,t,{blocked:e,upgrade:r,blocking:i,terminated:o}={}){const a=indexedDB.open(n,t),c=Yt(a);return r&&a.addEventListener("upgradeneeded",h=>{r(Yt(a.result),h.oldVersion,h.newVersion,Yt(a.transaction),h)}),e&&a.addEventListener("blocked",h=>e(h.oldVersion,h.newVersion,h)),c.then(h=>{o&&h.addEventListener("close",()=>o()),i&&h.addEventListener("versionchange",f=>i(f.oldVersion,f.newVersion,f))}).catch(()=>{}),c}const pc=["get","getKey","getAll","getAllKeys","count"],gc=["put","add","delete","clear"],is=new Map;function To(n,t){if(!(n instanceof IDBDatabase&&!(t in n)&&typeof t=="string"))return;if(is.get(t))return is.get(t);const e=t.replace(/FromIndex$/,""),r=t!==e,i=gc.includes(e);if(!(e in(r?IDBIndex:IDBObjectStore).prototype)||!(i||pc.includes(e)))return;const o=async function(a,...c){const h=this.transaction(a,i?"readwrite":"readonly");let f=h.store;return r&&(f=f.index(c.shift())),(await Promise.all([f[e](...c),i&&h.done]))[0]};return is.set(t,o),o}hc(n=>({...n,get:(t,e,r)=>To(t,e)||n.get(t,e,r),has:(t,e)=>!!To(t,e)||n.has(t,e)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _c{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(e=>{if(yc(e)){const r=e.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(e=>e).join(" ")}}function yc(n){const t=n.getComponent();return(t==null?void 0:t.type)==="VERSION"}const ms="@firebase/app",Io="0.10.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qt=new va("@firebase/app"),Ec="@firebase/app-compat",vc="@firebase/analytics-compat",Tc="@firebase/analytics",Ic="@firebase/app-check-compat",wc="@firebase/app-check",Ac="@firebase/auth",Rc="@firebase/auth-compat",Pc="@firebase/database",Cc="@firebase/data-connect",Sc="@firebase/database-compat",Vc="@firebase/functions",bc="@firebase/functions-compat",Dc="@firebase/installations",Nc="@firebase/installations-compat",kc="@firebase/messaging",Mc="@firebase/messaging-compat",Oc="@firebase/performance",xc="@firebase/performance-compat",Lc="@firebase/remote-config",Fc="@firebase/remote-config-compat",Bc="@firebase/storage",Uc="@firebase/storage-compat",qc="@firebase/firestore",jc="@firebase/vertexai-preview",$c="@firebase/firestore-compat",zc="firebase",Gc="10.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ps="[DEFAULT]",Kc={[ms]:"fire-core",[Ec]:"fire-core-compat",[Tc]:"fire-analytics",[vc]:"fire-analytics-compat",[wc]:"fire-app-check",[Ic]:"fire-app-check-compat",[Ac]:"fire-auth",[Rc]:"fire-auth-compat",[Pc]:"fire-rtdb",[Cc]:"fire-data-connect",[Sc]:"fire-rtdb-compat",[Vc]:"fire-fn",[bc]:"fire-fn-compat",[Dc]:"fire-iid",[Nc]:"fire-iid-compat",[kc]:"fire-fcm",[Mc]:"fire-fcm-compat",[Oc]:"fire-perf",[xc]:"fire-perf-compat",[Lc]:"fire-rc",[Fc]:"fire-rc-compat",[Bc]:"fire-gcs",[Uc]:"fire-gcs-compat",[qc]:"fire-fst",[$c]:"fire-fst-compat",[jc]:"fire-vertex","fire-js":"fire-js",[zc]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xc=Gc;function wa(n,t={}){let e=n;typeof t!="object"&&(t={name:t});const r=Object.assign({name:ps,automaticDataCollectionEnabled:!1},t),i=r.name;if(typeof i!="string"||!i)throw Xt.create("bad-app-name",{appName:String(i)});if(e||(e=ya()),!e)throw Xt.create("no-options");const o=lr.get(i);if(o){if(hs(e,o.options)&&hs(r,o.config))return o;throw Xt.create("duplicate-app",{appName:i})}const a=new ec(i);for(const h of gs.values())a.addComponent(h);const c=new Yc(e,r,a);return lr.set(i,c),c}function Jc(n=ps){const t=lr.get(n);if(!t&&n===ps&&ya())return wa();if(!t)throw Xt.create("no-app",{appName:n});return t}function Re(n,t,e){var r;let i=(r=Kc[n])!==null&&r!==void 0?r:n;e&&(i+=`-${e}`);const o=i.match(/\s|\//),a=t.match(/\s|\//);if(o||a){const c=[`Unable to register library "${i}" with version "${t}":`];o&&c.push(`library name "${i}" contains illegal characters (whitespace or "/")`),o&&a&&c.push("and"),a&&c.push(`version name "${t}" contains illegal characters (whitespace or "/")`),qt.warn(c.join(" "));return}cr(new gn(`${i}-version`,()=>({library:i,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zc="firebase-heartbeat-database",th=1,_n="firebase-heartbeat-store";let os=null;function Aa(){return os||(os=mc(Zc,th,{upgrade:(n,t)=>{switch(t){case 0:try{n.createObjectStore(_n)}catch(e){console.warn(e)}}}}).catch(n=>{throw Xt.create("idb-open",{originalErrorMessage:n.message})})),os}async function eh(n){try{const e=(await Aa()).transaction(_n),r=await e.objectStore(_n).get(Ra(n));return await e.done,r}catch(t){if(t instanceof Me)qt.warn(t.message);else{const e=Xt.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});qt.warn(e.message)}}}async function Ao(n,t){try{const r=(await Aa()).transaction(_n,"readwrite");await r.objectStore(_n).put(t,Ra(n)),await r.done}catch(e){if(e instanceof Me)qt.warn(e.message);else{const r=Xt.create("idb-set",{originalErrorMessage:e==null?void 0:e.message});qt.warn(r.message)}}}function Ra(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nh=1024,rh=30*24*60*60*1e3;class sh{constructor(t){this.container=t,this._heartbeatsCache=null;const e=this.container.getProvider("app").getImmediate();this._storage=new oh(e),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var t,e;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),o=Ro();return((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===o||this._heartbeatsCache.heartbeats.some(a=>a.date===o)?void 0:(this._heartbeatsCache.heartbeats.push({date:o,agent:i}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(a=>{const c=new Date(a.date).valueOf();return Date.now()-c<=rh}),this._storage.overwrite(this._heartbeatsCache))}catch(r){qt.warn(r)}}async getHeartbeatsHeader(){var t;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=Ro(),{heartbeatsToSend:r,unsentEntries:i}=ih(this._heartbeatsCache.heartbeats),o=ur(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=e,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),o}catch(e){return qt.warn(e),""}}}function Ro(){return new Date().toISOString().substring(0,10)}function ih(n,t=nh){const e=[];let r=n.slice();for(const i of n){const o=e.find(a=>a.agent===i.agent);if(o){if(o.dates.push(i.date),Po(e)>t){o.dates.pop();break}}else if(e.push({agent:i.agent,dates:[i.date]}),Po(e)>t){e.pop();break}r=r.slice(1)}return{heartbeatsToSend:e,unsentEntries:r}}class oh{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Hl()?Wl().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const e=await eh(this.app);return e!=null&&e.heartbeats?e:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){var e;if(await this._canUseIndexedDBPromise){const i=await this.read();return Ao(this.app,{lastSentHeartbeatDate:(e=t.lastSentHeartbeatDate)!==null&&e!==void 0?e:i.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){var e;if(await this._canUseIndexedDBPromise){const i=await this.read();return Ao(this.app,{lastSentHeartbeatDate:(e=t.lastSentHeartbeatDate)!==null&&e!==void 0?e:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...t.heartbeats]})}else return}}function Po(n){return ur(JSON.stringify({version:2,heartbeats:n})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ah(n){cr(new gn("platform-logger",t=>new _c(t),"PRIVATE")),cr(new gn("heartbeat",t=>new sh(t),"PRIVATE")),Re(ms,Io,n),Re(ms,Io,"esm2017"),Re("fire-js","")}ah("");var uh="firebase",lh="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Na{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class ch{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable(()=>e(yt.UNAUTHENTICATED))}shutdown(){}}class hh{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,e){this.changeListener=e,t.enqueueRetryable(()=>e(this.token.user))}shutdown(){this.changeListener=null}}class dh{constructor(t){this.t=t,this.currentUser=yt.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){H(this.o===void 0);let r=this.i;const i=h=>this.i!==r?(r=this.i,e(h)):Promise.resolve();let o=new ce;this.o=()=>{this.i++,this.currentUser=this.u(),o.resolve(),o=new ce,t.enqueueRetryable(()=>i(this.currentUser))};const a=()=>{const h=o;t.enqueueRetryable(async()=>{await h.promise,await i(this.currentUser)})},c=h=>{k("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=h,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(h=>c(h)),setTimeout(()=>{if(!this.auth){const h=this.t.getImmediate({optional:!0});h?c(h):(k("FirebaseAuthCredentialsProvider","Auth not yet detected"),o.resolve(),o=new ce)}},0),a()}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then(r=>this.i!==t?(k("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(H(typeof r.accessToken=="string"),new Na(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const t=this.auth&&this.auth.getUid();return H(t===null||typeof t=="string"),new yt(t)}}class fh{constructor(t,e,r){this.l=t,this.h=e,this.P=r,this.type="FirstParty",this.user=yt.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const t=this.T();return t&&this.I.set("Authorization",t),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class mh{constructor(t,e,r){this.l=t,this.h=e,this.P=r}getToken(){return Promise.resolve(new fh(this.l,this.h,this.P))}start(t,e){t.enqueueRetryable(()=>e(yt.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class ph{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class gh{constructor(t){this.A=t,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(t,e){H(this.o===void 0);const r=o=>{o.error!=null&&k("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${o.error.message}`);const a=o.token!==this.R;return this.R=o.token,k("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?e(o.token):Promise.resolve()};this.o=o=>{t.enqueueRetryable(()=>r(o))};const i=o=>{k("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=o,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(o=>i(o)),setTimeout(()=>{if(!this.appCheck){const o=this.A.getImmediate({optional:!0});o?i(o):k("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then(e=>e?(H(typeof e.token=="string"),this.R=e.token,new ph(e.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sn(n){if(n.code!==P.FAILED_PRECONDITION||n.message!==Ih)throw n;k("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vo(n){let t=0;for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t++;return t}function xe(n,t){for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t(e,n[e])}function Ma(n){for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dt{constructor(t){this.binaryString=t}static fromBase64String(t){const e=function(i){try{return atob(i)}catch(o){throw typeof DOMException<"u"&&o instanceof DOMException?new Oa("Invalid base64 string: "+o):o}}(t);return new dt(e)}static fromUint8Array(t){const e=function(i){let o="";for(let a=0;a<i.length;++a)o+=String.fromCharCode(i[a]);return o}(t);return new dt(e)}[Symbol.iterator](){let t=0;return{next:()=>t<this.binaryString.length?{value:this.binaryString.charCodeAt(t++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(e){return btoa(e)}(this.binaryString)}toUint8Array(){return function(e){const r=new Uint8Array(e.length);for(let i=0;i<e.length;i++)r[i]=e.charCodeAt(i);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return z(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}dt.EMPTY_BYTE_STRING=new dt("");const Ph=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function te(n){if(H(!!n),typeof n=="string"){let t=0;const e=Ph.exec(n);if(H(!!e),e[1]){let i=e[1];i=(i+"000000000").substr(0,9),t=Number(i)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:t}}return{seconds:et(n.seconds),nanos:et(n.nanos)}}function et(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function me(n){return typeof n=="string"?dt.fromBase64String(n):dt.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class In{constructor(t,e="asc"){this.field=t,this.dir=e}}function bh(n,t){return n.dir===t.dir&&n.field.isEqual(t.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class La{}class rt extends La{constructor(t,e,r){super(),this.field=t,this.op=e,this.value=r}static create(t,e,r){return t.isKeyField()?e==="in"||e==="not-in"?this.createKeyFieldInFilter(t,e,r):new Nh(t,e,r):e==="array-contains"?new Oh(t,r):e==="in"?new xh(t,r):e==="not-in"?new Lh(t,r):e==="array-contains-any"?new Fh(t,r):new rt(t,e,r)}static createKeyFieldInFilter(t,e,r){return e==="in"?new kh(t,r):new Mh(t,r)}matches(t){const e=t.data.field(this.field);return this.op==="!="?e!==null&&this.matchesComparison(Ve(e,this.value)):e!==null&&pe(this.value)===pe(e)&&this.matchesComparison(Ve(e,this.value))}matchesComparison(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return t===0;case"!=":return t!==0;case">":return t>0;case">=":return t>=0;default:return x()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class St extends La{constructor(t,e){super(),this.filters=t,this.op=e,this.ae=null}static create(t,e){return new St(t,e)}matches(t){return Fa(this)?this.filters.find(e=>!e.matches(t))===void 0:this.filters.find(e=>e.matches(t))!==void 0}getFlattenedFilters(){return this.ae!==null||(this.ae=this.filters.reduce((t,e)=>t.concat(e.getFlattenedFilters()),[])),this.ae}getFilters(){return Object.assign([],this.filters)}}function Fa(n){return n.op==="and"}function Ba(n){return Dh(n)&&Fa(n)}function Dh(n){for(const t of n.filters)if(t instanceof St)return!1;return!0}function vs(n){if(n instanceof rt)return n.field.canonicalString()+n.op.toString()+be(n.value);if(Ba(n))return n.filters.map(t=>vs(t)).join(",");{const t=n.filters.map(e=>vs(e)).join(",");return`${n.op}(${t})`}}function Ua(n,t){return n instanceof rt?function(r,i){return i instanceof rt&&r.op===i.op&&r.field.isEqual(i.field)&&kt(r.value,i.value)}(n,t):n instanceof St?function(r,i){return i instanceof St&&r.op===i.op&&r.filters.length===i.filters.length?r.filters.reduce((o,a,c)=>o&&Ua(a,i.filters[c]),!0):!1}(n,t):void x()}function qa(n){return n instanceof rt?function(e){return`${e.field.canonicalString()} ${e.op} ${be(e.value)}`}(n):n instanceof St?function(e){return e.op.toString()+" {"+e.getFilters().map(qa).join(" ,")+"}"}(n):"Filter"}class Nh extends rt{constructor(t,e,r){super(t,e,r),this.key=O.fromName(r.referenceValue)}matches(t){const e=O.comparator(t.key,this.key);return this.matchesComparison(e)}}class kh extends rt{constructor(t,e){super(t,"in",e),this.keys=ja("in",e)}matches(t){return this.keys.some(e=>e.isEqual(t.key))}}class Mh extends rt{constructor(t,e){super(t,"not-in",e),this.keys=ja("not-in",e)}matches(t){return!this.keys.some(e=>e.isEqual(t.key))}}function ja(n,t){var e;return(((e=t.arrayValue)===null||e===void 0?void 0:e.values)||[]).map(r=>O.fromName(r.referenceValue))}class Oh extends rt{constructor(t,e){super(t,"array-contains",e)}matches(t){const e=t.data.field(this.field);return Ls(e)&&Tn(e.arrayValue,this.value)}}class xh extends rt{constructor(t,e){super(t,"in",e)}matches(t){const e=t.data.field(this.field);return e!==null&&Tn(this.value.arrayValue,e)}}class Lh extends rt{constructor(t,e){super(t,"not-in",e)}matches(t){if(Tn(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const e=t.data.field(this.field);return e!==null&&!Tn(this.value.arrayValue,e)}}class Fh extends rt{constructor(t,e){super(t,"array-contains-any",e)}matches(t){const e=t.data.field(this.field);return!(!Ls(e)||!e.arrayValue.values)&&e.arrayValue.values.some(r=>Tn(this.value.arrayValue,r))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zh=new Z(O.comparator);function $t(){return zh}const Ka=new Z(O.comparator);function an(...n){let t=Ka;for(const e of n)t=t.insert(e.key,e);return t}function Ha(n){let t=Ka;return n.forEach((e,r)=>t=t.insert(e,r.overlayedDocument)),t}function ue(){return fn()}function Wa(){return fn()}function fn(){return new Fe(n=>n.toString(),(n,t)=>n.isEqual(t))}const Gh=new Z(O.comparator),Kh=new ht(O.comparator);function B(...n){let t=Kh;for(const e of n)t=t.add(e);return t}const Hh=new ht(z);function Wh(){return Hh}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qs(n,t){if(n.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:hr(t)?"-0":t}}function Qa(n){return{integerValue:""+n}}function Qh(n,t){return Rh(t)?Qa(t):qs(n,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sd{constructor(t){this.ct=t}}function Vd(n){const t=Id({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?fr(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nd{constructor(){this.changes=new Fe(t=>t.toString(),(t,e)=>t.isEqual(e)),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,Et.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const r=this.changes.get(e);return r!==void 0?C.resolve(r):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ld{constructor(){this.sessionToken=dt.EMPTY_BYTE_STRING}getSessionToken(t){return C.resolve(this.sessionToken)}setSessionToken(t,e){return this.sessionToken=e,C.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bd{constructor(t){this.Mr=t,this.docs=function(){return new Z(O.comparator)}(),this.size=0}setIndexManager(t){this.indexManager=t}addEntry(t,e){const r=e.key,i=this.docs.get(r),o=i?i.size:0,a=this.Mr(e);return this.docs=this.docs.insert(r,{document:e.mutableCopy(),size:a}),this.size+=a-o,this.indexManager.addToCollectionParentIndex(t,r.path.popLast())}removeEntry(t){const e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){const r=this.docs.get(e);return C.resolve(r?r.document.mutableCopy():Et.newInvalidDocument(e))}getEntries(t,e){let r=$t();return e.forEach(i=>{const o=this.docs.get(i);r=r.insert(i,o?o.document.mutableCopy():Et.newInvalidDocument(i))}),C.resolve(r)}getDocumentsMatchingQuery(t,e,r,i){let o=$t();const a=e.path,c=new O(a.child("")),h=this.docs.getIteratorFrom(c);for(;h.hasNext();){const{key:f,value:{document:p}}=h.getNext();if(!a.isPrefixOf(f.path))break;f.path.length>a.length+1||Th(vh(p),r)<=0||(i.has(p.key)||Ar(e,p))&&(o=o.insert(p.key,p.mutableCopy()))}return C.resolve(o)}getAllFromCollectionGroup(t,e,r,i){x()}Or(t,e){return C.forEach(this.docs,r=>e(r))}newChangeBuffer(t){return new Ud(this)}getSize(t){return C.resolve(this.size)}}class Ud extends Nd{constructor(t){super(),this.cr=t}applyChanges(t){const e=[];return this.changes.forEach((r,i)=>{i.isValidDocument()?e.push(this.cr.addEntry(t,i)):this.cr.removeEntry(r)}),C.waitFor(e)}getFromCache(t,e){return this.cr.getEntry(t,e)}getAllFromCache(t,e){return this.cr.getEntries(t,e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jd{constructor(t,e){this.qr={},this.overlays={},this.Qr=new Ms(0),this.Kr=!1,this.Kr=!0,this.$r=new Ld,this.referenceDelegate=t(this),this.Ur=new qd(this),this.indexManager=new bd,this.remoteDocumentCache=function(i){return new Bd(i)}(r=>this.referenceDelegate.Wr(r)),this.serializer=new Sd(e),this.Gr=new Od(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(t){return this.indexManager}getDocumentOverlayCache(t){let e=this.overlays[t.toKey()];return e||(e=new xd,this.overlays[t.toKey()]=e),e}getMutationQueue(t,e){let r=this.qr[t.toKey()];return r||(r=new Fd(e,this.referenceDelegate),this.qr[t.toKey()]=r),r}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(t,e,r){k("MemoryPersistence","Starting transaction:",t);const i=new $d(this.Qr.next());return this.referenceDelegate.zr(),r(i).next(o=>this.referenceDelegate.jr(i).next(()=>o)).toPromise().then(o=>(i.raiseOnCommittedEvent(),o))}Hr(t,e){return C.or(Object.values(this.qr).map(r=>()=>r.containsKey(t,e)))}}class $d extends wh{constructor(t){super(),this.currentSequenceNumber=t}}class Ks{constructor(t){this.persistence=t,this.Jr=new Gs,this.Yr=null}static Zr(t){return new Ks(t)}get Xr(){if(this.Yr)return this.Yr;throw x()}addReference(t,e,r){return this.Jr.addReference(r,e),this.Xr.delete(r.toString()),C.resolve()}removeReference(t,e,r){return this.Jr.removeReference(r,e),this.Xr.add(r.toString()),C.resolve()}markPotentiallyOrphaned(t,e){return this.Xr.add(e.toString()),C.resolve()}removeTarget(t,e){this.Jr.gr(e.targetId).forEach(i=>this.Xr.add(i.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(t,e.targetId).next(i=>{i.forEach(o=>this.Xr.add(o.toString()))}).next(()=>r.removeTargetData(t,e))}zr(){this.Yr=new Set}jr(t){const e=this.persistence.getRemoteDocumentCache().newChangeBuffer();return C.forEach(this.Xr,r=>{const i=O.fromPath(r);return this.ei(t,i).next(o=>{o||e.removeEntry(i,L.min())})}).next(()=>(this.Yr=null,e.apply(t)))}updateLimboDocument(t,e){return this.ei(t,e).next(r=>{r?this.Xr.delete(e.toString()):this.Xr.add(e.toString())})}Wr(t){return 0}ei(t,e){return C.or([()=>C.resolve(this.Jr.containsKey(e)),()=>this.persistence.getTargetCache().containsKey(t,e),()=>this.persistence.Hr(t,e)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gd{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return Kl()?8:Ah(zl())>0?6:4}()}initialize(t,e){this.Ji=t,this.indexManager=e,this.Gi=!0}getDocumentsMatchingQuery(t,e,r,i){const o={result:null};return this.Yi(t,e).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.Zi(t,e,i,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new zd;return this.Xi(t,e,a).next(c=>{if(o.result=c,this.zi)return this.es(t,e,a,c.size)})}).next(()=>o.result)}es(t,e,r,i){return r.documentReadCount<this.ji?(sn()<=j.DEBUG&&k("QueryEngine","SDK will not create cache indexes for query:",Ie(e),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),C.resolve()):(sn()<=j.DEBUG&&k("QueryEngine","Query:",Ie(e),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.Hi*i?(sn()<=j.DEBUG&&k("QueryEngine","The SDK decides to create cache indexes for query:",Ie(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,Vt(e))):C.resolve())}Yi(t,e){if(Bo(e))return C.resolve(null);let r=Vt(e);return this.indexManager.getIndexType(t,r).next(i=>i===0?null:(e.limit!==null&&i===1&&(e=fr(e,null,"F"),r=Vt(e)),this.indexManager.getDocumentsMatchingTarget(t,r).next(o=>{const a=B(...o);return this.Ji.getDocuments(t,a).next(c=>this.indexManager.getMinOffset(t,r).next(h=>{const f=this.ts(e,c);return this.ns(e,f,a,h.readTime)?this.Yi(t,fr(e,null,"F")):this.rs(t,f,e,h)}))})))}Zi(t,e,r,i){return Bo(e)||i.isEqual(L.min())?C.resolve(null):this.Ji.getDocuments(t,r).next(o=>{const a=this.ts(e,o);return this.ns(e,a,r,i)?C.resolve(null):(sn()<=j.DEBUG&&k("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Ie(e)),this.rs(t,a,e,Eh(i,-1)).next(c=>c))})}ts(t,e){let r=new ht(Ga(t));return e.forEach((i,o)=>{Ar(t,o)&&(r=r.add(o))}),r}ns(t,e,r,i){if(t.limit===null)return!1;if(r.size!==e.size)return!0;const o=t.limitType==="F"?e.last():e.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(i)>0)}Xi(t,e,r){return sn()<=j.DEBUG&&k("QueryEngine","Using full collection scan to execute query:",Ie(e)),this.Ji.getDocumentsMatchingQuery(t,e,Zt.min(),r)}rs(t,e,r,i){return this.Ji.getDocumentsMatchingQuery(t,r,i).next(o=>(e.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sr(n){return new md(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gu{constructor(t,e,r,i,o,a,c,h){this.ui=t,this.Ho=r,this.Jo=i,this.connection=o,this.authCredentialsProvider=a,this.appCheckCredentialsProvider=c,this.listener=h,this.state=0,this.Yo=0,this.Zo=null,this.Xo=null,this.stream=null,this.e_=0,this.t_=new pu(t,e)}n_(){return this.state===1||this.state===5||this.r_()}r_(){return this.state===2||this.state===3}start(){this.e_=0,this.state!==4?this.auth():this.i_()}async stop(){this.n_()&&await this.close(0)}s_(){this.state=0,this.t_.reset()}o_(){this.r_()&&this.Zo===null&&(this.Zo=this.ui.enqueueAfterDelay(this.Ho,6e4,()=>this.__()))}a_(t){this.u_(),this.stream.send(t)}async __(){if(this.r_())return this.close(0)}u_(){this.Zo&&(this.Zo.cancel(),this.Zo=null)}c_(){this.Xo&&(this.Xo.cancel(),this.Xo=null)}async close(t,e){this.u_(),this.c_(),this.t_.cancel(),this.Yo++,t!==4?this.t_.reset():e&&e.code===P.RESOURCE_EXHAUSTED?(jt(e.toString()),jt("Using maximum backoff delay to prevent overloading the backend."),this.t_.Wo()):e&&e.code===P.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.l_(),this.stream.close(),this.stream=null),this.state=t,await this.listener.mo(e)}l_(){}auth(){this.state=1;const t=this.h_(this.Yo),e=this.Yo;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([r,i])=>{this.Yo===e&&this.P_(r,i)},r=>{t(()=>{const i=new N(P.UNKNOWN,"Fetching auth token failed: "+r.message);return this.I_(i)})})}P_(t,e){const r=this.h_(this.Yo);this.stream=this.T_(t,e),this.stream.Eo(()=>{r(()=>this.listener.Eo())}),this.stream.Ro(()=>{r(()=>(this.state=2,this.Xo=this.ui.enqueueAfterDelay(this.Jo,1e4,()=>(this.r_()&&(this.state=3),Promise.resolve())),this.listener.Ro()))}),this.stream.mo(i=>{r(()=>this.I_(i))}),this.stream.onMessage(i=>{r(()=>++this.e_==1?this.E_(i):this.onNext(i))})}i_(){this.state=5,this.t_.Go(async()=>{this.state=0,this.start()})}I_(t){return k("PersistentStream",`close with error: ${t}`),this.stream=null,this.close(4,t)}h_(t){return e=>{this.ui.enqueueAndForget(()=>this.Yo===t?e():(k("PersistentStream","stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class of extends gu{constructor(t,e,r,i,o,a){super(t,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",e,r,i,a),this.serializer=o}T_(t,e){return this.connection.Bo("Listen",t,e)}E_(t){return this.onNext(t)}onNext(t){this.t_.reset();const e=_d(this.serializer,t),r=function(o){if(!("targetChange"in o))return L.min();const a=o.targetChange;return a.targetIds&&a.targetIds.length?L.min():a.readTime?bt(a.readTime):L.min()}(t);return this.listener.d_(e,r)}A_(t){const e={};e.database=Ps(this.serializer),e.addTarget=function(o,a){let c;const h=a.target;if(c=Ts(h)?{documents:vd(o,h)}:{query:Td(o,h)._t},c.targetId=a.targetId,a.resumeToken.approximateByteSize()>0){c.resumeToken=ou(o,a.resumeToken);const f=ws(o,a.expectedCount);f!==null&&(c.expectedCount=f)}else if(a.snapshotVersion.compareTo(L.min())>0){c.readTime=pr(o,a.snapshotVersion.toTimestamp());const f=ws(o,a.expectedCount);f!==null&&(c.expectedCount=f)}return c}(this.serializer,t);const r=wd(this.serializer,t);r&&(e.labels=r),this.a_(e)}R_(t){const e={};e.database=Ps(this.serializer),e.removeTarget=t,this.a_(e)}}class af extends gu{constructor(t,e,r,i,o,a){super(t,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",e,r,i,a),this.serializer=o}get V_(){return this.e_>0}start(){this.lastStreamToken=void 0,super.start()}l_(){this.V_&&this.m_([])}T_(t,e){return this.connection.Bo("Write",t,e)}E_(t){return H(!!t.streamToken),this.lastStreamToken=t.streamToken,H(!t.writeResults||t.writeResults.length===0),this.listener.f_()}onNext(t){H(!!t.streamToken),this.lastStreamToken=t.streamToken,this.t_.reset();const e=Ed(t.writeResults,t.commitTime),r=bt(t.commitTime);return this.listener.g_(r,e)}p_(){const t={};t.database=Ps(this.serializer),this.a_(t)}m_(t){const e={streamToken:this.lastStreamToken,writes:t.map(r=>yd(this.serializer,r))};this.a_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cf{constructor(t,e,r,i,o){this.localStore=t,this.datastore=e,this.asyncQueue=r,this.remoteSyncer={},this.O_=[],this.N_=new Map,this.L_=new Set,this.B_=[],this.k_=o,this.k_._o(a=>{r.enqueueAndForget(async()=>{_e(this)&&(k("RemoteStore","Restarting streams for network reachability change."),await async function(h){const f=F(h);f.L_.add(4),await Nn(f),f.q_.set("Unknown"),f.L_.delete(4),await Vr(f)}(this))})}),this.q_=new lf(r,i)}}async function Vr(n){if(_e(n))for(const t of n.B_)await t(!0)}async function Nn(n){for(const t of n.B_)await t(!1)}function _u(n,t){const e=F(n);e.N_.has(t.targetId)||(e.N_.set(t.targetId,t),Xs(e)?Ys(e):Be(e).r_()&&Qs(e,t))}function Ws(n,t){const e=F(n),r=Be(e);e.N_.delete(t),r.r_()&&yu(e,t),e.N_.size===0&&(r.r_()?r.o_():_e(e)&&e.q_.set("Unknown"))}function Qs(n,t){if(n.Q_.xe(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(L.min())>0){const e=n.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(e)}Be(n).A_(t)}function yu(n,t){n.Q_.xe(t),Be(n).R_(t)}function Ys(n){n.Q_=new cd({getRemoteKeysForTarget:t=>n.remoteSyncer.getRemoteKeysForTarget(t),ot:t=>n.N_.get(t)||null,tt:()=>n.datastore.serializer.databaseId}),Be(n).start(),n.q_.v_()}function Xs(n){return _e(n)&&!Be(n).n_()&&n.N_.size>0}function _e(n){return F(n).L_.size===0}function Eu(n){n.Q_=void 0}async function hf(n){n.q_.set("Online")}async function df(n){n.N_.forEach((t,e)=>{Qs(n,t)})}async function ff(n,t){Eu(n),Xs(n)?(n.q_.M_(t),Ys(n)):n.q_.set("Unknown")}async function mf(n,t,e){if(n.q_.set("Online"),t instanceof iu&&t.state===2&&t.cause)try{await async function(i,o){const a=o.cause;for(const c of o.targetIds)i.N_.has(c)&&(await i.remoteSyncer.rejectListen(c,a),i.N_.delete(c),i.Q_.removeTarget(c))}(n,t)}catch(r){k("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),r),await gr(n,r)}else if(t instanceof or?n.Q_.Ke(t):t instanceof su?n.Q_.He(t):n.Q_.We(t),!e.isEqual(L.min()))try{const r=await mu(n.localStore);e.compareTo(r)>=0&&await function(o,a){const c=o.Q_.rt(a);return c.targetChanges.forEach((h,f)=>{if(h.resumeToken.approximateByteSize()>0){const p=o.N_.get(f);p&&o.N_.set(f,p.withResumeToken(h.resumeToken,a))}}),c.targetMismatches.forEach((h,f)=>{const p=o.N_.get(h);if(!p)return;o.N_.set(h,p.withResumeToken(dt.EMPTY_BYTE_STRING,p.snapshotVersion)),yu(o,h);const w=new Qt(p.target,h,f,p.sequenceNumber);Qs(o,w)}),o.remoteSyncer.applyRemoteEvent(c)}(n,e)}catch(r){k("RemoteStore","Failed to raise snapshot:",r),await gr(n,r)}}async function gr(n,t,e){if(!Vn(t))throw t;n.L_.add(1),await Nn(n),n.q_.set("Offline"),e||(e=()=>mu(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{k("RemoteStore","Retrying IndexedDB access"),await e(),n.L_.delete(1),await Vr(n)})}function vu(n,t){return t().catch(e=>gr(n,e,t))}async function br(n){const t=F(n),e=ee(t);let r=t.O_.length>0?t.O_[t.O_.length-1].batchId:-1;for(;pf(t);)try{const i=await Xd(t.localStore,r);if(i===null){t.O_.length===0&&e.o_();break}r=i.batchId,gf(t,i)}catch(i){await gr(t,i)}Tu(t)&&Iu(t)}function pf(n){return _e(n)&&n.O_.length<10}function gf(n,t){n.O_.push(t);const e=ee(n);e.r_()&&e.V_&&e.m_(t.mutations)}function Tu(n){return _e(n)&&!ee(n).n_()&&n.O_.length>0}function Iu(n){ee(n).start()}async function _f(n){ee(n).p_()}async function yf(n){const t=ee(n);for(const e of n.O_)t.m_(e.mutations)}async function Ef(n,t,e){const r=n.O_.shift(),i=js.from(r,t,e);await vu(n,()=>n.remoteSyncer.applySuccessfulWrite(i)),await br(n)}async function vf(n,t){t&&ee(n).V_&&await async function(r,i){if(function(a){return ad(a)&&a!==P.ABORTED}(i.code)){const o=r.O_.shift();ee(r).s_(),await vu(r,()=>r.remoteSyncer.rejectFailedWrite(o.batchId,i)),await br(r)}}(n,t),Tu(n)&&Iu(n)}async function Zo(n,t){const e=F(n);e.asyncQueue.verifyOperationInProgress(),k("RemoteStore","RemoteStore received new credentials");const r=_e(e);e.L_.add(3),await Nn(e),r&&e.q_.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.L_.delete(3),await Vr(e)}async function Tf(n,t){const e=F(n);t?(e.L_.delete(2),await Vr(e)):t||(e.L_.add(2),await Nn(e),e.q_.set("Unknown"))}function Be(n){return n.K_||(n.K_=function(e,r,i){const o=F(e);return o.w_(),new of(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,i)}(n.datastore,n.asyncQueue,{Eo:hf.bind(null,n),Ro:df.bind(null,n),mo:ff.bind(null,n),d_:mf.bind(null,n)}),n.B_.push(async t=>{t?(n.K_.s_(),Xs(n)?Ys(n):n.q_.set("Unknown")):(await n.K_.stop(),Eu(n))})),n.K_}function ee(n){return n.U_||(n.U_=function(e,r,i){const o=F(e);return o.w_(),new af(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,i)}(n.datastore,n.asyncQueue,{Eo:()=>Promise.resolve(),Ro:_f.bind(null,n),mo:vf.bind(null,n),f_:yf.bind(null,n),g_:Ef.bind(null,n)}),n.B_.push(async t=>{t?(n.U_.s_(),await br(n)):(await n.U_.stop(),n.O_.length>0&&(k("RemoteStore",`Stopping write stream with ${n.O_.length} pending writes`),n.O_=[]))})),n.U_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wu{constructor(t){this.key=t}}class Au{constructor(t){this.key=t}}class Vf{constructor(t,e){this.query=t,this.Ta=e,this.Ea=null,this.hasCachedResults=!1,this.current=!1,this.da=B(),this.mutatedKeys=B(),this.Aa=Ga(t),this.Ra=new Pe(this.Aa)}get Va(){return this.Ta}ma(t,e){const r=e?e.fa:new ta,i=e?e.Ra:this.Ra;let o=e?e.mutatedKeys:this.mutatedKeys,a=i,c=!1;const h=this.query.limitType==="F"&&i.size===this.query.limit?i.last():null,f=this.query.limitType==="L"&&i.size===this.query.limit?i.first():null;if(t.inorderTraversal((p,w)=>{const R=i.get(p),S=Ar(this.query,w)?w:null,D=!!R&&this.mutatedKeys.has(R.key),M=!!S&&(S.hasLocalMutations||this.mutatedKeys.has(S.key)&&S.hasCommittedMutations);let b=!1;R&&S?R.data.isEqual(S.data)?D!==M&&(r.track({type:3,doc:S}),b=!0):this.ga(R,S)||(r.track({type:2,doc:S}),b=!0,(h&&this.Aa(S,h)>0||f&&this.Aa(S,f)<0)&&(c=!0)):!R&&S?(r.track({type:0,doc:S}),b=!0):R&&!S&&(r.track({type:1,doc:R}),b=!0,(h||f)&&(c=!0)),b&&(S?(a=a.add(S),o=M?o.add(p):o.delete(p)):(a=a.delete(p),o=o.delete(p)))}),this.query.limit!==null)for(;a.size>this.query.limit;){const p=this.query.limitType==="F"?a.last():a.first();a=a.delete(p.key),o=o.delete(p.key),r.track({type:1,doc:p})}return{Ra:a,fa:r,ns:c,mutatedKeys:o}}ga(t,e){return t.hasLocalMutations&&e.hasCommittedMutations&&!e.hasLocalMutations}applyChanges(t,e,r,i){const o=this.Ra;this.Ra=t.Ra,this.mutatedKeys=t.mutatedKeys;const a=t.fa.G_();a.sort((p,w)=>function(S,D){const M=b=>{switch(b){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return x()}};return M(S)-M(D)}(p.type,w.type)||this.Aa(p.doc,w.doc)),this.pa(r),i=i!=null&&i;const c=e&&!i?this.ya():[],h=this.da.size===0&&this.current&&!i?1:0,f=h!==this.Ea;return this.Ea=h,a.length!==0||f?{snapshot:new Ne(this.query,t.Ra,o,a,t.mutatedKeys,h===0,f,!1,!!r&&r.resumeToken.approximateByteSize()>0),wa:c}:{wa:c}}Z_(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({Ra:this.Ra,fa:new ta,mutatedKeys:this.mutatedKeys,ns:!1},!1)):{wa:[]}}Sa(t){return!this.Ta.has(t)&&!!this.Ra.has(t)&&!this.Ra.get(t).hasLocalMutations}pa(t){t&&(t.addedDocuments.forEach(e=>this.Ta=this.Ta.add(e)),t.modifiedDocuments.forEach(e=>{}),t.removedDocuments.forEach(e=>this.Ta=this.Ta.delete(e)),this.current=t.current)}ya(){if(!this.current)return[];const t=this.da;this.da=B(),this.Ra.forEach(r=>{this.Sa(r.key)&&(this.da=this.da.add(r.key))});const e=[];return t.forEach(r=>{this.da.has(r)||e.push(new Au(r))}),this.da.forEach(r=>{t.has(r)||e.push(new wu(r))}),e}ba(t){this.Ta=t.Ts,this.da=B();const e=this.ma(t.documents);return this.applyChanges(e,!0)}Da(){return Ne.fromInitialDocuments(this.query,this.Ra,this.mutatedKeys,this.Ea===0,this.hasCachedResults)}}class bf{constructor(t,e,r){this.query=t,this.targetId=e,this.view=r}}class Df{constructor(t){this.key=t,this.va=!1}}class Nf{constructor(t,e,r,i,o,a){this.localStore=t,this.remoteStore=e,this.eventManager=r,this.sharedClientState=i,this.currentUser=o,this.maxConcurrentLimboResolutions=a,this.Ca={},this.Fa=new Fe(c=>za(c),wr),this.Ma=new Map,this.xa=new Set,this.Oa=new Z(O.comparator),this.Na=new Map,this.La=new Gs,this.Ba={},this.ka=new Map,this.qa=De.kn(),this.onlineState="Unknown",this.Qa=void 0}get isPrimaryClient(){return this.Qa===!0}}async function kf(n,t,e=!0){const r=bu(n);let i;const o=r.Fa.get(t);return o?(r.sharedClientState.addLocalQueryTarget(o.targetId),i=o.view.Da()):i=await Ru(r,t,e,!0),i}async function Mf(n,t){const e=bu(n);await Ru(e,t,!0,!1)}async function Ru(n,t,e,r){const i=await Jd(n.localStore,Vt(t)),o=i.targetId,a=n.sharedClientState.addLocalQueryTarget(o,e);let c;return r&&(c=await Of(n,t,o,a==="current",i.resumeToken)),n.isPrimaryClient&&e&&_u(n.remoteStore,i),c}async function Of(n,t,e,r,i){n.Ka=(w,R,S)=>async function(M,b,G,W){let Y=b.view.ma(G);Y.ns&&(Y=await Yo(M.localStore,b.query,!1).then(({documents:v})=>b.view.ma(v,Y)));const it=W&&W.targetChanges.get(b.targetId),Mt=W&&W.targetMismatches.get(b.targetId)!=null,at=b.view.applyChanges(Y,M.isPrimaryClient,it,Mt);return sa(M,b.targetId,at.wa),at.snapshot}(n,w,R,S);const o=await Yo(n.localStore,t,!0),a=new Vf(t,o.Ts),c=a.ma(o.documents),h=Dn.createSynthesizedTargetChangeForCurrentChange(e,r&&n.onlineState!=="Offline",i),f=a.applyChanges(c,n.isPrimaryClient,h);sa(n,e,f.wa);const p=new bf(t,e,a);return n.Fa.set(t,p),n.Ma.has(e)?n.Ma.get(e).push(t):n.Ma.set(e,[t]),f.snapshot}async function xf(n,t,e){const r=F(n),i=r.Fa.get(t),o=r.Ma.get(i.targetId);if(o.length>1)return r.Ma.set(i.targetId,o.filter(a=>!wr(a,t))),void r.Fa.delete(t);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(i.targetId),r.sharedClientState.isActiveQueryTarget(i.targetId)||await Cs(r.localStore,i.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(i.targetId),e&&Ws(r.remoteStore,i.targetId),Vs(r,i.targetId)}).catch(Sn)):(Vs(r,i.targetId),await Cs(r.localStore,i.targetId,!0))}async function Lf(n,t){const e=F(n),r=e.Fa.get(t),i=e.Ma.get(r.targetId);e.isPrimaryClient&&i.length===1&&(e.sharedClientState.removeLocalQueryTarget(r.targetId),Ws(e.remoteStore,r.targetId))}async function Ff(n,t,e){const r=Gf(n);try{const i=await function(a,c){const h=F(a),f=st.now(),p=c.reduce((S,D)=>S.add(D.key),B());let w,R;return h.persistence.runTransaction("Locally write mutations","readwrite",S=>{let D=$t(),M=B();return h.cs.getEntries(S,p).next(b=>{D=b,D.forEach((G,W)=>{W.isValidDocument()||(M=M.add(G))})}).next(()=>h.localDocuments.getOverlayedDocuments(S,D)).next(b=>{w=b;const G=[];for(const W of c){const Y=nd(W,w.get(W.key).overlayedDocument);Y!=null&&G.push(new ge(W.key,Y,xa(Y.value.mapValue),Ut.exists(!0)))}return h.mutationQueue.addMutationBatch(S,f,G,c)}).next(b=>{R=b;const G=b.applyToLocalDocumentSet(w,M);return h.documentOverlayCache.saveOverlays(S,b.batchId,G)})}).then(()=>({batchId:R.batchId,changes:Ha(w)}))}(r.localStore,t);r.sharedClientState.addPendingMutation(i.batchId),function(a,c,h){let f=a.Ba[a.currentUser.toKey()];f||(f=new Z(z)),f=f.insert(c,h),a.Ba[a.currentUser.toKey()]=f}(r,i.batchId,e),await kn(r,i.changes),await br(r.remoteStore)}catch(i){const o=Zs(i,"Failed to persist write");e.reject(o)}}async function Pu(n,t){const e=F(n);try{const r=await Qd(e.localStore,t);t.targetChanges.forEach((i,o)=>{const a=e.Na.get(o);a&&(H(i.addedDocuments.size+i.modifiedDocuments.size+i.removedDocuments.size<=1),i.addedDocuments.size>0?a.va=!0:i.modifiedDocuments.size>0?H(a.va):i.removedDocuments.size>0&&(H(a.va),a.va=!1))}),await kn(e,r,t)}catch(r){await Sn(r)}}function ra(n,t,e){const r=F(n);if(r.isPrimaryClient&&e===0||!r.isPrimaryClient&&e===1){const i=[];r.Fa.forEach((o,a)=>{const c=a.view.Z_(t);c.snapshot&&i.push(c.snapshot)}),function(a,c){const h=F(a);h.onlineState=c;let f=!1;h.queries.forEach((p,w)=>{for(const R of w.j_)R.Z_(c)&&(f=!0)}),f&&ti(h)}(r.eventManager,t),i.length&&r.Ca.d_(i),r.onlineState=t,r.isPrimaryClient&&r.sharedClientState.setOnlineState(t)}}async function Bf(n,t,e){const r=F(n);r.sharedClientState.updateQueryState(t,"rejected",e);const i=r.Na.get(t),o=i&&i.key;if(o){let a=new Z(O.comparator);a=a.insert(o,Et.newNoDocument(o,L.min()));const c=B().add(o),h=new Cr(L.min(),new Map,new Z(z),a,c);await Pu(r,h),r.Oa=r.Oa.remove(o),r.Na.delete(t),ei(r)}else await Cs(r.localStore,t,!1).then(()=>Vs(r,t,e)).catch(Sn)}async function Uf(n,t){const e=F(n),r=t.batch.batchId;try{const i=await Wd(e.localStore,t);Su(e,r,null),Cu(e,r),e.sharedClientState.updateMutationState(r,"acknowledged"),await kn(e,i)}catch(i){await Sn(i)}}async function qf(n,t,e){const r=F(n);try{const i=await function(a,c){const h=F(a);return h.persistence.runTransaction("Reject batch","readwrite-primary",f=>{let p;return h.mutationQueue.lookupMutationBatch(f,c).next(w=>(H(w!==null),p=w.keys(),h.mutationQueue.removeMutationBatch(f,w))).next(()=>h.mutationQueue.performConsistencyCheck(f)).next(()=>h.documentOverlayCache.removeOverlaysForBatchId(f,p,c)).next(()=>h.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(f,p)).next(()=>h.localDocuments.getDocuments(f,p))})}(r.localStore,t);Su(r,t,e),Cu(r,t),r.sharedClientState.updateMutationState(t,"rejected",e),await kn(r,i)}catch(i){await Sn(i)}}function Cu(n,t){(n.ka.get(t)||[]).forEach(e=>{e.resolve()}),n.ka.delete(t)}function Su(n,t,e){const r=F(n);let i=r.Ba[r.currentUser.toKey()];if(i){const o=i.get(t);o&&(e?o.reject(e):o.resolve(),i=i.remove(t)),r.Ba[r.currentUser.toKey()]=i}}function Vs(n,t,e=null){n.sharedClientState.removeLocalQueryTarget(t);for(const r of n.Ma.get(t))n.Fa.delete(r),e&&n.Ca.$a(r,e);n.Ma.delete(t),n.isPrimaryClient&&n.La.gr(t).forEach(r=>{n.La.containsKey(r)||Vu(n,r)})}function Vu(n,t){n.xa.delete(t.path.canonicalString());const e=n.Oa.get(t);e!==null&&(Ws(n.remoteStore,e),n.Oa=n.Oa.remove(t),n.Na.delete(e),ei(n))}function sa(n,t,e){for(const r of e)r instanceof wu?(n.La.addReference(r.key,t),jf(n,r)):r instanceof Au?(k("SyncEngine","Document no longer in limbo: "+r.key),n.La.removeReference(r.key,t),n.La.containsKey(r.key)||Vu(n,r.key)):x()}function jf(n,t){const e=t.key,r=e.path.canonicalString();n.Oa.get(e)||n.xa.has(r)||(k("SyncEngine","New document in limbo: "+e),n.xa.add(r),ei(n))}function ei(n){for(;n.xa.size>0&&n.Oa.size<n.maxConcurrentLimboResolutions;){const t=n.xa.values().next().value;n.xa.delete(t);const e=new O(J.fromString(t)),r=n.qa.next();n.Na.set(r,new Df(e)),n.Oa=n.Oa.insert(e,r),_u(n.remoteStore,new Qt(Vt(Us(e.path)),r,"TargetPurposeLimboResolution",Ms.oe))}}async function kn(n,t,e){const r=F(n),i=[],o=[],a=[];r.Fa.isEmpty()||(r.Fa.forEach((c,h)=>{a.push(r.Ka(h,t,e).then(f=>{var p;if((f||e)&&r.isPrimaryClient){const w=f?!f.fromCache:(p=e==null?void 0:e.targetChanges.get(h.targetId))===null||p===void 0?void 0:p.current;r.sharedClientState.updateQueryState(h.targetId,w?"current":"not-current")}if(f){i.push(f);const w=Hs.Wi(h.targetId,f);o.push(w)}}))}),await Promise.all(a),r.Ca.d_(i),await async function(h,f){const p=F(h);try{await p.persistence.runTransaction("notifyLocalViewChanges","readwrite",w=>C.forEach(f,R=>C.forEach(R.$i,S=>p.persistence.referenceDelegate.addReference(w,R.targetId,S)).next(()=>C.forEach(R.Ui,S=>p.persistence.referenceDelegate.removeReference(w,R.targetId,S)))))}catch(w){if(!Vn(w))throw w;k("LocalStore","Failed to update sequence numbers: "+w)}for(const w of f){const R=w.targetId;if(!w.fromCache){const S=p.os.get(R),D=S.snapshotVersion,M=S.withLastLimboFreeSnapshotVersion(D);p.os=p.os.insert(R,M)}}}(r.localStore,o))}async function $f(n,t){const e=F(n);if(!e.currentUser.isEqual(t)){k("SyncEngine","User change. New user:",t.toKey());const r=await fu(e.localStore,t);e.currentUser=t,function(o,a){o.ka.forEach(c=>{c.forEach(h=>{h.reject(new N(P.CANCELLED,a))})}),o.ka.clear()}(e,"'waitForPendingWrites' promise is rejected due to a user change."),e.sharedClientState.handleUserChange(t,r.removedBatchIds,r.addedBatchIds),await kn(e,r.hs)}}function zf(n,t){const e=F(n),r=e.Na.get(t);if(r&&r.va)return B().add(r.key);{let i=B();const o=e.Ma.get(t);if(!o)return i;for(const a of o){const c=e.Fa.get(a);i=i.unionWith(c.view.Va)}return i}}function bu(n){const t=F(n);return t.remoteStore.remoteSyncer.applyRemoteEvent=Pu.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=zf.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=Bf.bind(null,t),t.Ca.d_=Pf.bind(null,t.eventManager),t.Ca.$a=Cf.bind(null,t.eventManager),t}function Gf(n){const t=F(n);return t.remoteStore.remoteSyncer.applySuccessfulWrite=Uf.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=qf.bind(null,t),t}class _r{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=Sr(t.databaseInfo.databaseId),this.sharedClientState=this.Wa(t),this.persistence=this.Ga(t),await this.persistence.start(),this.localStore=this.za(t),this.gcScheduler=this.ja(t,this.localStore),this.indexBackfillerScheduler=this.Ha(t,this.localStore)}ja(t,e){return null}Ha(t,e){return null}za(t){return Hd(this.persistence,new Gd,t.initialUser,this.serializer)}Ga(t){return new jd(Ks.Zr,this.serializer)}Wa(t){return new tf}async terminate(){var t,e;(t=this.gcScheduler)===null||t===void 0||t.stop(),(e=this.indexBackfillerScheduler)===null||e===void 0||e.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}_r.provider={build:()=>new _r};class bs{async initialize(t,e){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(e),this.remoteStore=this.createRemoteStore(e),this.eventManager=this.createEventManager(e),this.syncEngine=this.createSyncEngine(e,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>ra(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=$f.bind(null,this.syncEngine),await Tf(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return function(){return new wf}()}createDatastore(t){const e=Sr(t.databaseInfo.databaseId),r=function(o){return new sf(o)}(t.databaseInfo);return function(o,a,c,h){return new uf(o,a,c,h)}(t.authCredentials,t.appCheckCredentials,r,e)}createRemoteStore(t){return function(r,i,o,a,c){return new cf(r,i,o,a,c)}(this.localStore,this.datastore,t.asyncQueue,e=>ra(this.syncEngine,e,0),function(){return Jo.D()?new Jo:new ef}())}createSyncEngine(t,e){return function(i,o,a,c,h,f,p){const w=new Nf(i,o,a,c,h,f);return p&&(w.Qa=!0),w}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,e)}async terminate(){var t,e;await async function(i){const o=F(i);k("RemoteStore","RemoteStore shutting down."),o.L_.add(5),await Nn(o),o.k_.shutdown(),o.q_.set("Unknown")}(this.remoteStore),(t=this.datastore)===null||t===void 0||t.terminate(),(e=this.eventManager)===null||e===void 0||e.terminate()}}bs.provider={build:()=>new bs};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kf{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.Ya(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.Ya(this.observer.error,t):jt("Uncaught Error in snapshot listener:",t.toString()))}Za(){this.muted=!0}Ya(t,e){setTimeout(()=>{this.muted||t(e)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const em=/^__.*__$/;class nm{constructor(t,e,r){this.data=t,this.fieldMask=e,this.fieldTransforms=r}toMutation(t,e){return this.fieldMask!==null?new ge(t,this.data,this.fieldMask,e,this.fieldTransforms):new bn(t,this.data,e,this.fieldTransforms)}}function xu(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw x()}}class oi{constructor(t,e,r,i,o,a){this.settings=t,this.databaseId=e,this.serializer=r,this.ignoreUndefinedProperties=i,o===void 0&&this.vu(),this.fieldTransforms=o||[],this.fieldMask=a||[]}get path(){return this.settings.path}get Cu(){return this.settings.Cu}Fu(t){return new oi(Object.assign(Object.assign({},this.settings),t),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Mu(t){var e;const r=(e=this.path)===null||e===void 0?void 0:e.child(t),i=this.Fu({path:r,xu:!1});return i.Ou(t),i}Nu(t){var e;const r=(e=this.path)===null||e===void 0?void 0:e.child(t),i=this.Fu({path:r,xu:!1});return i.vu(),i}Lu(t){return this.Fu({path:void 0,xu:!0})}Bu(t){return Er(t,this.settings.methodName,this.settings.ku||!1,this.path,this.settings.qu)}contains(t){return this.fieldMask.find(e=>t.isPrefixOf(e))!==void 0||this.fieldTransforms.find(e=>t.isPrefixOf(e.field))!==void 0}vu(){if(this.path)for(let t=0;t<this.path.length;t++)this.Ou(this.path.get(t))}Ou(t){if(t.length===0)throw this.Bu("Document fields must not be empty");if(xu(this.Cu)&&em.test(t))throw this.Bu('Document fields cannot begin and end with "__"')}}class rm{constructor(t,e,r){this.databaseId=t,this.ignoreUndefinedProperties=e,this.serializer=r||Sr(t)}Qu(t,e,r,i=!1){return new oi({Cu:t,methodName:e,qu:r,path:ct.emptyPath(),xu:!1,ku:i},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Lu(n){const t=n._freezeSettings(),e=Sr(n._databaseId);return new rm(n._databaseId,!!t.ignoreUndefinedProperties,e)}function sm(n,t,e,r,i,o={}){const a=n.Qu(o.merge||o.mergeFields?2:0,t,e,i);Uu("Data must be an object, but it was:",a,r);const c=Fu(r,a);let h,f;if(o.merge)h=new Ct(a.fieldMask),f=a.fieldTransforms;else if(o.mergeFields){const p=[];for(const w of o.mergeFields){const R=om(t,w,e);if(!a.contains(R))throw new N(P.INVALID_ARGUMENT,`Field '${R}' is specified in your field mask but missing from your input data.`);um(p,R)||p.push(R)}h=new Ct(p),f=a.fieldTransforms.filter(w=>h.covers(w.field))}else h=null,f=a.fieldTransforms;return new nm(new Rt(c),h,f)}class ai extends ri{_toFieldTransform(t){return new Jh(t.path,new wn)}isEqual(t){return t instanceof ai}}function im(n,t,e,r=!1){return ui(e,n.Qu(r?4:3,t))}function ui(n,t){if(Bu(n=de(n)))return Uu("Unsupported field value:",t,n),Fu(n,t);if(n instanceof ri)return function(r,i){if(!xu(i.Cu))throw i.Bu(`${r._methodName}() can only be used with update() and set()`);if(!i.path)throw i.Bu(`${r._methodName}() is not currently supported inside arrays`);const o=r._toFieldTransform(i);o&&i.fieldTransforms.push(o)}(n,t),null;if(n===void 0&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),n instanceof Array){if(t.settings.xu&&t.Cu!==4)throw t.Bu("Nested arrays are not supported");return function(r,i){const o=[];let a=0;for(const c of r){let h=ui(c,i.Lu(a));h==null&&(h={nullValue:"NULL_VALUE"}),o.push(h),a++}return{arrayValue:{values:o}}}(n,t)}return function(r,i){if((r=de(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return Qh(i.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){const o=st.fromDate(r);return{timestampValue:pr(i.serializer,o)}}if(r instanceof st){const o=new st(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:pr(i.serializer,o)}}if(r instanceof si)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof ke)return{bytesValue:ou(i.serializer,r._byteString)};if(r instanceof At){const o=i.databaseId,a=r.firestore._databaseId;if(!a.isEqual(o))throw i.Bu(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${o.projectId}/${o.database}`);return{referenceValue:zs(r.firestore._databaseId||i.databaseId,r._key.path)}}if(r instanceof ii)return function(a,c){return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:a.toArray().map(h=>{if(typeof h!="number")throw c.Bu("VectorValues must only contain numeric values.");return qs(c.serializer,h)})}}}}}}(r,i);throw i.Bu(`Unsupported field value: ${Dr(r)}`)}(n,t)}function Fu(n,t){const e={};return Ma(n)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):xe(n,(r,i)=>{const o=ui(i,t.Mu(r));o!=null&&(e[r]=o)}),{mapValue:{fields:e}}}function Bu(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof st||n instanceof si||n instanceof ke||n instanceof At||n instanceof ri||n instanceof ii)}function Uu(n,t,e){if(!Bu(e)||!function(i){return typeof i=="object"&&i!==null&&(Object.getPrototypeOf(i)===Object.prototype||Object.getPrototypeOf(i)===null)}(e)){const r=Dr(e);throw r==="an object"?t.Bu(n+" a custom object"):t.Bu(n+" "+r)}}function om(n,t,e){if((t=de(t))instanceof ni)return t._internalPath;if(typeof t=="string")return qu(n,t);throw Er("Field path arguments must be of type string or ",n,!1,void 0,e)}const am=new RegExp("[~\\*/\\[\\]]");function qu(n,t,e){if(t.search(am)>=0)throw Er(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,e);try{return new ni(...t.split("."))._internalPath}catch{throw Er(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,e)}}function Er(n,t,e,r,i){const o=r&&!r.isEmpty(),a=i!==void 0;let c=`Function ${t}() called with invalid data`;e&&(c+=" (via `toFirestore()`)"),c+=". ";let h="";return(o||a)&&(h+=" (found",o&&(h+=` in field ${r}`),a&&(h+=` in document ${i}`),h+=")"),new N(P.INVALID_ARGUMENT,c+n+h)}function um(n,t){return n.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pm(n,t,e){let r;return r=n?n.toFirestore(t):t,r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ln{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class zu extends ju{constructor(t,e,r,i,o,a){super(t,e,r,i,a),this._firestore=t,this._firestoreImpl=t,this.metadata=o}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new ar(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const r=this._document.data.field(li("DocumentSnapshot.get",t));if(r!==null)return this._userDataWriter.convertValue(r,e.serverTimestamps)}}}class ar extends zu{data(t={}){return super.data(t)}}class gm{constructor(t,e,r,i){this._firestore=t,this._userDataWriter=e,this._snapshot=i,this.metadata=new ln(i.hasPendingWrites,i.fromCache),this.query=r}get docs(){const t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(t,e){this._snapshot.docs.forEach(r=>{t.call(e,new ar(this._firestore,this._userDataWriter,r.key,r,new ln(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new N(P.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(i,o){if(i._snapshot.oldDocs.isEmpty()){let a=0;return i._snapshot.docChanges.map(c=>{const h=new ar(i._firestore,i._userDataWriter,c.doc.key,c.doc,new ln(i._snapshot.mutatedKeys.has(c.doc.key),i._snapshot.fromCache),i.query.converter);return c.doc,{type:"added",doc:h,oldIndex:-1,newIndex:a++}})}{let a=i._snapshot.oldDocs;return i._snapshot.docChanges.filter(c=>o||c.type!==3).map(c=>{const h=new ar(i._firestore,i._userDataWriter,c.doc.key,c.doc,new ln(i._snapshot.mutatedKeys.has(c.doc.key),i._snapshot.fromCache),i.query.converter);let f=-1,p=-1;return c.type!==0&&(f=a.indexOf(c.doc.key),a=a.delete(c.doc.key)),c.type!==1&&(a=a.add(c.doc),p=a.indexOf(c.doc.key)),{type:_m(c.type),doc:h,oldIndex:f,newIndex:p}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}}function _m(n){switch(n){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return x()}}class Gu extends mm{constructor(t){super(),this.firestore=t}convertBytes(t){return new ke(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new At(this.firestore,null,e)}}function ym(n,t){const e=pn(n.firestore,yr),r=Jf(n),i=pm(n.converter,t);return vm(e,[sm(Lu(n.firestore),"addDoc",r._key,i,n.converter!==null,{}).toMutation(r._key,Ut.exists(!1))]).then(()=>r)}function Em(n,...t){var e,r,i;n=de(n);let o={includeMetadataChanges:!1,source:"default"},a=0;typeof t[a]!="object"||da(t[a])||(o=t[a],a++);const c={includeMetadataChanges:o.includeMetadataChanges,source:o.source};if(da(t[a])){const w=t[a];t[a]=(e=w.next)===null||e===void 0?void 0:e.bind(w),t[a+1]=(r=w.error)===null||r===void 0?void 0:r.bind(w),t[a+2]=(i=w.complete)===null||i===void 0?void 0:i.bind(w)}let h,f,p;if(n instanceof At)f=pn(n.firestore,yr),p=Us(n._key.path),h={next:w=>{t[a]&&t[a](Tm(f,n,w))},error:t[a+1],complete:t[a+2]};else{const w=pn(n,ne);f=pn(w.firestore,yr),p=w._query;const R=new Gu(f);h={next:S=>{t[a]&&t[a](new gm(f,R,w,S))},error:t[a+1],complete:t[a+2]},cm(n._query)}return function(R,S,D,M){const b=new Kf(M),G=new Sf(S,b,D);return R.asyncQueue.enqueueAndForget(async()=>Af(await oa(R),G)),()=>{b.Za(),R.asyncQueue.enqueueAndForget(async()=>Rf(await oa(R),G))}}(Ou(f),p,c,h)}function vm(n,t){return function(r,i){const o=new ce;return r.asyncQueue.enqueueAndForget(async()=>Ff(await Qf(r),i,o)),o.promise}(Ou(n),t)}function Tm(n,t,e){const r=e.docs.get(t._key),i=new Gu(n);return new zu(n,i,t._key,r,new ln(e.hasPendingWrites,e.fromCache),t.converter)}function Im(){return new ai("serverTimestamp")}(function(t,e=!0){(function(i){Oe=i})(Xc),cr(new gn("firestore",(r,{instanceIdentifier:i,options:o})=>{const a=r.getProvider("app").getImmediate(),c=new yr(new dh(r.getProvider("auth-internal")),new gh(r.getProvider("app-check-internal")),function(f,p){if(!Object.prototype.hasOwnProperty.apply(f.options,["projectId"]))throw new N(P.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new vn(f.options.projectId,p)}(a,i),a);return o=Object.assign({useFetchStreams:e},o),c._setSettings(o),c},"PUBLIC").setMultipleInstances(!0)),Re(So,"4.7.3",t),Re(So,"4.7.3","esm2017")})();console.log("Environment variables available:");console.log("VITE_FIREBASE_APIKEY:","AIzaSyBL8O3QL6eNDibwY6LMJaI9fmUAbujIVJE");console.log("VITE_FIREBASE_AUTH_DOMAIN:","whac-a-g-spot.firebaseapp.com");console.log("VITE_FIREBASE_PROJECT_ID:","whac-a-g-spot");const Wt={apiKey:"AIzaSyBL8O3QL6eNDibwY6LMJaI9fmUAbujIVJE",authDomain:"whac-a-g-spot.firebaseapp.com",projectId:"whac-a-g-spot",storageBucket:"whac-a-g-spot.firebasestorage.app",messagingSenderId:"934482651756",appId:"1:934482651756:web:6bdee2e7f28e38e7ccc649",measurementId:"G-VBGNLCNXBL"};console.log("Firebase config:",Wt);const wm=Wt.apiKey&&Wt.authDomain&&Wt.projectId&&Wt.storageBucket&&Wt.messagingSenderId&&Wt.appId;let vr;if(wm){const n=wa(Wt);vr=Zf(n),console.log("Firebase initialized successfully")}else console.warn("Firebase configuration incomplete. Leaderboard features will be disabled."),vr={collection:()=>({add:()=>Promise.resolve(),orderBy:()=>({limit:()=>({onSnapshot:(n,t)=>(n({forEach:e=>{}}),()=>{})})})})};let q,K,It=0,Ue=!1,Pn=!1,Dt,Nt,Ft,cn,he,Bt=30,Cn=!1,Ku=0,Tr=!1;window.onload=function(){Am(),document.getElementById("startBtn").addEventListener("click",Cm),document.getElementById("restartBtn").addEventListener("click",Yu),document.getElementById("restartBtn").disabled=!0,Ft=document.getElementById("custom-cursor"),cn=document.getElementById("board"),Rm(),bm(),km()};function Am(){const n=document.getElementById("board");n.innerHTML="";for(let t=0;t<9;t++){let e=document.createElement("div");e.id=t.toString(),e.addEventListener("click",Pm),e.style.cssText="cursor: pointer; position: relative; z-index: 2;",n.appendChild(e)}}function Rm(){cn.addEventListener("mouseenter",function(){Ft.style.display="block"}),cn.addEventListener("mouseleave",function(){Ft.style.display="none"}),cn.addEventListener("mousemove",function(n){Ft.style.left=n.clientX+"px",Ft.style.top=n.clientY+"px"}),cn.addEventListener("click",function(){Ft.classList.remove("cursor-hit"),Ft.offsetWidth,Ft.classList.add("cursor-hit"),setTimeout(()=>{Ft.classList.remove("cursor-hit")},300)})}function Hu(){return Math.floor(Math.random()*9).toString()}function Wu(){if(!Pn||Ue)return;q&&(q.innerHTML="");let n=document.createElement("img");n.src="./characterP_nor.png";let t=Hu();K&&K.id==t||(q=document.getElementById(t),q&&(q.appendChild(n),setTimeout(()=>{n.parentNode===q&&n.classList.add("pop-up")},10)))}function Qu(){if(!Pn||Ue)return;K&&(K.innerHTML="");let n=document.createElement("img");n.src="./characterG_nor.png";let t=Hu();q&&q.id==t||(K=document.getElementById(t),K&&(K.appendChild(n),setTimeout(()=>{n.parentNode===K&&n.classList.add("pop-up")},10)))}function Pm(){if(Ue)return;let n=Cn?20:10;this==q?(It-=n,It<0&&(It=0),document.getElementById("score").innerText=It.toString(),q&&q.firstChild&&(q.firstChild.src="./characterP_angry.png",setTimeout(()=>{q&&q.firstChild&&(q.firstChild.src="./characterP_nor.png")},300))):this==K&&(K&&K.firstChild&&K.firstChild.src.includes("characterG_nor")?(It+=n,document.getElementById("score").innerText=It.toString(),K&&K.firstChild&&(K.firstChild.src="./characterG_happy.png"),q&&q.firstChild&&(q.firstChild.src="./characterP_angry.png",setTimeout(()=>{q&&q.firstChild&&(q.firstChild.src="./characterP_nor.png")},300)),setTimeout(()=>{K&&K.firstChild&&(K.firstChild.src="./characterG_nor.png")},1e3)):K&&K.firstChild&&K.firstChild.src.includes("characterG_happy")&&(It+=n,document.getElementById("score").innerText=It.toString(),q&&q.firstChild&&(q.firstChild.src="./characterP_angry.png",setTimeout(()=>{q&&q.firstChild&&(q.firstChild.src="./characterP_nor.png")},300)),setTimeout(()=>{K&&K.firstChild&&(K.firstChild.src="./characterG_nor.png")},1e3)))}function Cm(){Pn||(Pn=!0,Ue=!1,Cn=!1,It=0,Bt=30,document.getElementById("score").innerText=It.toString(),document.getElementById("timer").innerText=Bt+"s",document.getElementById("startBtn").disabled=!0,document.getElementById("restartBtn").disabled=!1,Dt&&clearInterval(Dt),Nt&&clearInterval(Nt),he&&clearInterval(he),Dt=setInterval(Wu,1e3),Nt=setInterval(Qu,2e3),he=setInterval(()=>{Bt--,document.getElementById("timer").innerText=Bt+"s",Bt<=10&&!Cn&&Sm(),Bt<=0&&Vm()},1e3),q&&(q.innerHTML=""),K&&(K.innerHTML=""),q=null,K=null)}function Sm(){Cn=!0,Dt&&clearInterval(Dt),Nt&&clearInterval(Nt),Dt=setInterval(Wu,500),Nt=setInterval(Qu,1e3),document.getElementById("timer").innerText=Bt+"s FEVER!",document.getElementById("timer").style.color="#FFD700";let n=document.createElement("div");n.id="fever-notice",n.innerText="FEVER MODE! +20 points per hit!",n.style.position="fixed",n.style.top="50%",n.style.left="50%",n.style.transform="translate(-50%, -50%)",n.style.backgroundColor="#FFD700",n.style.color="#000",n.style.padding="20px",n.style.borderRadius="10px",n.style.fontSize="24px",n.style.fontWeight="bold",n.style.zIndex="10000",n.style.boxShadow="0 0 20px rgba(255, 215, 0, 0.8)",document.body.appendChild(n),setTimeout(()=>{n.parentNode&&n.parentNode.removeChild(n)},3e3)}function Yu(){Dt&&clearInterval(Dt),Nt&&clearInterval(Nt),he&&clearInterval(he),q&&(q.innerHTML=""),K&&(K.innerHTML=""),q=null,K=null,Pn=!1,Ue=!1,Cn=!1,Tr=!1,It=0,Bt=30,document.getElementById("score").innerText=It.toString(),document.getElementById("timer").innerText=Bt+"s",document.getElementById("timer").style.color="#e52521",document.getElementById("startBtn").disabled=!1,document.getElementById("restartBtn").disabled=!0,document.getElementById("add-score").style.display="none";let n=document.getElementById("fever-notice");n&&n.parentNode.removeChild(n)}function Vm(){Dt&&clearInterval(Dt),Nt&&clearInterval(Nt),he&&clearInterval(he),Ue=!0,Ku=It,document.getElementById("score").innerText="FINAL SCORE: "+It.toString(),document.getElementById("restartBtn").disabled=!1,Tr||(document.getElementById("add-score").style.display="block",document.getElementById("player-name").focus())}function bm(){document.getElementById("save-score").addEventListener("click",Nm);const n=hm(Mu(vr,"leaderboard"),dm("score","desc"),fm(10));Em(n,t=>{const e=[];t.forEach(r=>{e.push(r.data())}),Dm(e)},t=>{console.error("Error listening to leaderboard:",t)})}function Dm(n){const t=document.getElementById("leaderboard-body");t.innerHTML="";for(let e=0;e<Math.min(n.length,10);e++){const r=document.createElement("tr");r.innerHTML=`
            <td>${e+1}</td>
            <td>${n[e].name}</td>
            <td>${n[e].score}</td>
        `,t.appendChild(r)}}function Nm(){const n=document.getElementById("player-name"),t=document.getElementById("player-email"),e=n.value.trim(),r=t.value.trim();if(e===""){alert("Please enter your name");return}if(Tr){alert("Score already saved!");return}const i={name:e,score:Ku,timestamp:Im()};r&&(i.email=r),ym(Mu(vr,"leaderboard"),i).then(()=>{Tr=!0,document.getElementById("add-score").style.display="none",n.value="",t.value="",Mm()}).catch(o=>{console.error("Error saving score to Firestore:",o),alert("Failed to save score. Please check Firestore security rules.")})}function km(){document.getElementById("close-popup").addEventListener("click",pa),document.getElementById("success-popup").addEventListener("click",function(n){n.target===this&&pa()})}function Mm(){document.getElementById("success-popup").style.display="flex"}function pa(){document.getElementById("success-popup").style.display="none",Yu()}
