...
function setCharacterP() {
    ...
    characterP.src = `${import.meta.env.BASE_URL}characterP_nor.png`;
...
function setCharacterG() {
    ...
    characterG.src = `${import.meta.env.BASE_URL}characterG_nor.png`;
...
function selectTile() {
    ...
    if (this == currCharacterPTile) {
        ...
        if (currCharacterPTile && currCharacterPTile.firstChild) {
            currCharacterPTile.firstChild.src = `${import.meta.env.BASE_URL}characterP_angry.png`;
            
            // Reset characterP image after a delay
            setTimeout(() => {
                if (currCharacterPTile && currCharacterPTile.firstChild) {
                    currCharacterPTile.firstChild.src = `${import.meta.env.BASE_URL}characterP_nor.png`;
                }
            }, 300);
        }
    }
    // Check if we're hitting the characterG (normal or happy)
        ...
        if (currCharacterGTile && currCharacterGTile.firstChild && 
            ...
            if (currCharacterGTile && currCharacterGTile.firstChild) {
                currCharacterGTile.firstChild.src = `${import.meta.env.BASE_URL}characterG_happy.png`;
            }
            ...
            setTimeout(() => {
                if (currCharacterGTile && currCharacterGTile.firstChild) {
                    currCharacterGTile.firstChild.src = `${import.meta.env.BASE_URL}characterG_nor.png`;
                }
            }, 1000);
